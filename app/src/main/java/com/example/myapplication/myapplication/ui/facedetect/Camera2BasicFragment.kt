...
import com.example.myapplication.myapplication.custom.AutoFitTextureView
import java.io.File
...
class Camera2BasicFragment @SuppressLint("ValidFragment") private constructor(
...
//    }
    ...
    object : CameraCaptureSession.CaptureCallback() {
        ...
        private fun process(result: CaptureResult) {
            when (state) {
                STATE_PREVIEW -> UInt// Do nothing when the camera preview is working normally.
...
//            manager.openCamera(cameraId, stateCallback, backgroundHandler)
            manager.openCamera(manager.cameraIdList[1], stateCallback, backgroundHandler)
    ...
    private fun runPrecaptureSequence() {
        try {
            ...
            previewRequestBuilder.set(
                ...
                CaptureRequest.LENS_FACING_FRONT
            )
...
//            R.id.picture -> lockFocus()
    ...
    companion object {
        ...
        private fun chooseOptimalSize(
            ...
            if (bigEnough.size > 0) {
                return Collections.min(bigEnough, CameraConnectionFragment.CompareSizesByArea())
            } else if (notBigEnough.size > 0) {
                return Collections.max(notBigEnough, CameraConnectionFragment.CompareSizesByArea())
            } else {
        ...
        fun newInstance(
            ...
            return Camera2BasicFragment(imageListener)
        }
    }
}